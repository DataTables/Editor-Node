...
export default class SearchBuilderOptions {
     ...
     */
    label(label: string[]): SearchBuilderOptions;
    /**
     ...
     * @returns {Options} Self for chaining
     */
    order(order: string): SearchBuilderOptions;
    /**
     ...
     * @returns {Options} Self for chaining
     */
    render(fn: IRenderer): SearchBuilderOptions;
    /**
     ...
     * @returns {Options} Self for chaining
     */
    table(table: string): SearchBuilderOptions;
    /**
     ...
     * @returns {Options} Self for chaining
     */
    value(value: string): SearchBuilderOptions;
    /**
     ...
     * @returns {Options} Self for chaining
     */
    where(where: any): SearchBuilderOptions;
    /**
